...
## equation for X only with defined INDUCTION par from not gate and adjusted distance equation to left more freedom at transition
...
#infact we only need 6 concentration, 2 stable, 2 oscillation, 2 stable
ARA=ARA[[0,1,4,5,8,9]]
